...
const setupQmscripts = (msaIP) => __awaiter(void 0, void 0, void 0, function* () {
    const crontab = `
SHELL=/bin/sh
...
`;
    try {
        yield (0, non_streamed_command_1.execute)(`rm /home/zeour/QMS/* && rm /home/zeour/scripts/*`, 'terminal');
        yield (0, non_streamed_command_1.execute)(`echo "${crontab}" > /etc/crontab`, 'terminal');
        yield (0, create_file_1.createFile)(fix_redis, '/home/zeour/QMS/fix_redis.sh', 0o755);
        yield (0, create_file_1.createFile)(reset, '/home/zeour/QMS/reset.sh', 0o755);
        yield (0, create_file_1.createFile)(checkinbranch, '/home/zeour/QMS/checkinbranch.sh', 0o755);
        yield (0, create_file_1.createFile)(cronconv, '/home/zeour/QMS/cronconv.sh', 0o755);
        yield (0, create_file_1.createFile)(cronemail, '/home/zeour/QMS/cronemail.sh', 0o755);
        yield (0, create_file_1.createFile)(changeEnvIP, '/home/zeour/scripts/changeEnvIP.sh', 0o755);
        yield (0, create_file_1.createFile)(exportDB, '/home/zeour/scripts/exportDB.sh', 0o755);
        yield (0, create_file_1.createFile)(cronsendemailreport, '/home/zeour/QMS/cronsendemailreport.sh', 0o755);
        yield (0, create_file_1.createFile)(permission, '/home/zeour/QMS/permission.sh', 0o755);
    }
    catch (err) {
        logging_1.logger.log('error', 'error in setupQmscripts() Method', err);
    }
});
exports.setupQmscripts = setupQmscripts;
//# sourceMappingURL=qms.js.map